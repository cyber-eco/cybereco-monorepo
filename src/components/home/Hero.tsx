...
const Title = styled(motion.h1)<ThemedProps>`
...
const PrimaryText = styled.span<ThemedProps>`
  color: ${({ theme }) => theme.secondary};
  display: block;
`;

const Description = styled(motion.p)<ThemedProps>`
...
const PrimaryButton = styled(Link)<ThemedProps>`
...
const SecondaryButton = styled(Link)<ThemedProps>`
...
const HeroImage = styled(motion.div)<ThemedProps>`
  position: relative;
  width: 100%;
  max-width: 450px;
  aspect-ratio: 1 / 1;
...
const CircleDecoration = styled.div<ThemedProps>`
  position: absolute;
  width: 400px;
  height: 400px;
  border-radius: 50%;
