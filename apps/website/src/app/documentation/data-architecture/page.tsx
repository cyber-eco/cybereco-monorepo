      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.subtitle}>
            {t('common:dataArchitecture.subtitle') || 'Centralized data management with distributed application consumption'}
          </p>
        </div>
      </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.keyPoints}>
              ...
              <ul>
                <li>
                  <FaCheck />
                  <span>{t('common:dataArchitecture.overview.point1') || 'Single source of truth for all shared data'}</span>
                </li>
                <li>
                  <FaCheck />
                  <span>{t('common:dataArchitecture.overview.point2') || 'Apps maintain only app-specific data'}</span>
                </li>
                <li>
                  <FaCheck />
                  <span>{t('common:dataArchitecture.overview.point3') || 'Real-time synchronization across applications'}</span>
                </li>
                <li>
                  <FaCheck />
                  <span>{t('common:dataArchitecture.overview.point4') || 'Centralized permissions and access control'}</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.architectureDiagram}>
              <div className={styles.hubSection}>
                <h3>{t('common:dataArchitecture.architecture.hubServices') || 'Hub Services'}</h3>
              ...
              <div className={styles.dataModels}>
                <h3>{t('common:dataArchitecture.architecture.dataModels') || 'Shared Data Models'}</h3>
            ...
            <div className={styles.apiStructure}>
              <h3>{t('common:dataArchitecture.architecture.apiStructure') || 'API Structure'}</h3>
              <CodeBlock
                id="api-structure"
        ...
        <div className={styles.footerContent}>
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinks}>
              <li><Link href="/documentation">{t('common:dataArchitecture.footer.allDocs') || 'All Documentation'}</Link></li>
              <li><Link href="/documentation/authentication">{t('common:dataArchitecture.footer.authentication') || 'Authentication'}</Link></li>
              <li><a href="/documentation#api-reference">{t('common:dataArchitecture.footer.apiReference') || 'API Reference'}</a></li>
            </ul>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinks}>
              <li><a href="https://github.com/cybereco">{t('common:dataArchitecture.footer.github') || 'GitHub'}</a></li>
              <li><a href="/roadmap">{t('common:dataArchitecture.footer.roadmap') || 'Roadmap'}</a></li>
              <li><a href="/contact">{t('common:dataArchitecture.footer.contact') || 'Contact'}</a></li>
            </ul>
          </div>
        </div>
      </div>
